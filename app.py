...
# ==============================
if not file:
    st.info("Upload your `.xls/.xlsx` costing sheet to parse it automatically (same layout as your screenshots).")
    st.stop()
...
st.info(f"Risk band (5–95%): {fmt_money(p5)} – {fmt_money(p95)} • Median: {fmt_money(p50)}")
